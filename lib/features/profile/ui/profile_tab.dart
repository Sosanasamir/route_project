...
class ProfileTab extends StatelessWidget {
  ...
  Widget _buildWatchListSection() {
    return _buildEmptyState("Watchlist is empty", Icons.movie_outlined);
  }

  Widget _buildHistorySection() {
    return BlocBuilder<MovieCubit, MovieState>(
      builder: (context, state) {
        final history = context.read<MovieCubit>().historyMovies;
  ...
  Widget _buildMovieThumbnail(BuildContext context, MovieModel movie) {
    return InkWell(
      onTap: () {
